...
@Entity(name = "ElementSalaire")
@Table(name = "elementsalaire")
public class ElementSalaire extends AbstractEntity {
    ...
    @OneToMany(mappedBy = "elementSalaire")
    private List<ElementSalaireBase> elementSalaireBase;

    @OneToMany(mappedBy = "elementSalaire")
    private List<ElementSalaireBareme> elementSalaireBareme;
}
