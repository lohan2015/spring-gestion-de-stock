...
public interface ParamApi {
    ...
    @ApiOperation(value = "Rechercher un salarié par matricule", notes = "Cette methode permet de chercher un salarié par son CODE"
            , responseContainer = "List<ParamDataDto>")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Rechercher un salarié par matricule", notes = "Cette methode permet de chercher un salarié par son CODE", responseContainer = "List<ParamDataDto>")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Le salarié a ete trouve dans la BDD"),
            @ApiResponse(code = 404, message = "Aucun salarié n'existe dans la BDD avec le CODE fourni")
    })
    ...
    @PostMapping(value = APP_ROOT_PAIE + "/parametrage/donnee/filter3", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    ResponseEntity<ParamDataDto> findDataByNumeroLigne(@RequestBody(required = false) ParamDataDto param);
    ...
    @ApiOperation(value = "Rechercher une colonne par numéro de table", notes = "Cette methode permet de chercher un salarié par son CODE"
            , responseContainer = "List<ParamColumnDto>")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Le salarié a ete trouve dans la BDD"),
            @ApiResponse(code = 404, message = "Aucun salarié n'existe dans la BDD avec le CODE fourni")
    })
